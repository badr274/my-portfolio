...
const HomePage = () => {
  return (
    <main className=" pb-25 layout">
      {/* <Layout> */}
      <div className="container mx-auto text-dark dark:text-light flex flex-col gap-y-5 md:flex-row items-center justify-between lg:justify-around w-full pt-5">
        ...
        <div className="w-full md:w-2/3 lg:w-1/2 flex items-center md:items-start flex-col self-center">
          ...
          <p className="my-4 text-xs sm:text-sm md:text-base font-medium">
            I&apos;m a passionate Frontend Developer with hands-on experience as
            a freelancer, focused on building modern, high-performance web
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              ...
              className="text-sm sm:text-base md:text-lg font-medium capitalize text-dark dark:text-light underline"
            >
              Contact
            </Link>
          </div>
