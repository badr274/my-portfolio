    ...
    <div className=" md:fixed md:left-4 md:bottom-4 flex items-center justify-center overflow-hidden text-circular">
      <div className="w-24 md:w-48 h-auto flex items-center justify-center relative">
        ...
        <Link
          ...
          bg-dark text-light shadow-md border border-dark w-12 h-12 md:h-20 md:w-20 rounded-full font-semibold 
          hover:bg-light hover:text-dark duration-150 text-[10px] md:text-base"
        >
          Hire Me
        </Link>
      </div>
