...
export const FacebookIcon = ({ className, ...rest }: IProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
...
export const WhatsAppIcon = ({ className, ...rest }: IProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
  ...
  >
    ...
    <g fill="none">
      ...
      <path
        fill="#fff"
        d="M128.3 63.9c-33.2 0-60.1 26.9-60.1 60.1 0 10.6 2.8 20.9 8 29.9L72.4 192l38.9-10.2c8.5 4.6 18.1 7.1 27.8 7.1 33.2 0 60.1-26.9 60.1-60.1s-26.9-60.1-60.1-60.1zm0 104.7c-9 0-17.9-2.5-25.6-7.2l-1.8-1.1-23.1 6 6.2-22.4-1.2-1.9c-4.8-7.7-7.3-16.6-7.3-25.7 0-26.7 21.7-48.4 48.4-48.4s48.4 21.7 48.4 48.4-21.7 48.4-48.4 48.4zm27.7-35.5c-1.5-.8-8.8-4.4-10.1-4.9-1.3-.5-2.3-.8-3.3.8s-3.8 4.9-4.7 5.9c-.9 1.1-1.7 1.2-3.2.4s-6.2-2.3-11.9-7.3c-4.4-3.9-7.4-8.7-8.3-10.2-.9-1.5-.1-2.3.7-3.1.7-.7 1.5-1.8 2.3-2.7.8-1 1.1-1.7 1.6-2.7.5-1 .2-2-.1-2.8s-3.3-7.9-4.6-10.8c-1.2-2.9-2.4-2.5-3.3-2.6-.8-.1-1.7-.1-2.6-.1s-2.4.3-3.6 1.6-4.8 4.7-4.8 11.5c0 6.8 4.9 13.3 5.5 14.2.7.9 9.6 14.6 23.4 20.5 13.8 5.9 13.8 3.9 16.3 3.7 2.5-.2 8.1-3.3 9.3-6.4 1.1-3.1 1.1-5.7.8-6.3-.3-.6-1.3-.9-2.8-1.7z"
      />
    </g>
  </svg>
);
